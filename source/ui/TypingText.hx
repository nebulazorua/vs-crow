// modified from https://raw.githubusercontent.com/HaxeFlixel/flixel-addons/master/flixel/addons/text/FlxTypeText.hx by Nebula for FNF X Nefarious
// Lets you have a chance for typing sound instead of making it always play on every letter
 ...
 * @author Noel Berry
 */
class TypingText extends FlxText
{
	/**
  ...
  /**
  * Chance from 0.0 to 100.0 that a sound will be played when typing; optional.
  */
  public var soundChance:Float = 100.0;
